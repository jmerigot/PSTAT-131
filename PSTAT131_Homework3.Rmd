...
```
There is a good amount of missing data in the training data, 522 missing data values to be exact, especially for the *age* and *cabin* variables, as can be seen using the code above.
